function trainingData4voices = extractTrainingData4voices(varargin)
% trainingData4voices = extractTrainingData4voices(varargin)
%
% Get probabilities of note pitches and transitions from the given 
% training data, which should be one or more 4-voice Bach fugues, as:
%
...
trainingData4voices = {probIntV1 probIntV2 probIntV3 probIntV4 ... 
                        probPitchV1 probPitchV2 probPitchV3 probPitchV4};
