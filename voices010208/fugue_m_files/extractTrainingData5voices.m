function trainingData5voices = extractTrainingData5voices(varargin)
% trainingData5voices = extractTrainingData5voices(varargin)
%
% Get probabilities of note pitches and transitions from the given 
% training data, which should be one or more 5-voice Bach fugues, as:
%
...
for i=1:2:size(varargin, 2)
    ...
    fugueV4 = getmidich(fugue, 4);
    fugueV5 = getmidich(fugue, 5);
    ...
    fugueV4 = transpose(fugueV4(:, 4));     
    fugueV5 = transpose(fugueV5(:, 4));   
    ...
    probPitchV4 = probPitchV4 + getNoteProbs(fugueV4);
    probPitchV5 = probPitchV5 + getNoteProbs(fugueV5);
    ...
    probIntV4 = probIntV4 + getProbs(fugueV4);
    probIntV5 = probIntV5 + getProbs(fugueV5);
...
probPitchV4 = probPitchV4/numFugues;
probPitchV5 = probPitchV5/numFugues;
 
probIntV1 = probIntV1/numFugues;
probIntV2 = probIntV2/numFugues;
probIntV3 = probIntV3/numFugues;
probIntV4 = probIntV4/numFugues;
probIntV5 = probIntV5/numFugues;
 
trainingData5voices = {probIntV1 probIntV2 probIntV3 probIntV4 probIntV5 ... 
              probPitchV1 probPitchV2 probPitchV3 probPitchV4 probPitchV5};
